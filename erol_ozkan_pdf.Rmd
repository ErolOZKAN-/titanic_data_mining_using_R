...
In this section, we will do outlier detection using three different methods; dbscan, Torgo (2007) and Breunig et al. (2000).

## DBSCAN
Let's first define the dbscan.outliers function.
